            ...
            <div class="table-responsive">
                <table class="table table-vcenter card-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" placeholder="Agregar beneficio" rows="1" wire:model.defer="beneficioAgregar"></textarea>
                            @error('beneficioAgregar')
                    ...
                    @foreach($beneficios as $index => $beneficio)
                        <tr>
                            <td class="ps-2 p-0">
                                <button class="btn btn-ghost-light btn-icon" wire:click="$emit('triggerDelete',{{ $beneficio->idbeneficio }})">
                            ...
                            <td><textarea class="form-control" rows="1" wire:model.defer="beneficios.{{ $index }}.beneficio"></textarea></td>
                        </tr>
                    @endforeach

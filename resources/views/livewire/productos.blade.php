            ...
            <div class="table-responsive">
                <table class="table table-vcenter card-table">
                    ...
                    @foreach($productos as $index => $producto)
                        <tr>
                            <td class="ps-2 p-0">
                                <button class="btn btn-ghost-light btn-icon" wire:click="$emit('triggerDelete',{{ $producto->idproducto }})">
                            ...
                            <td><textarea class="form-control" rows="1" wire:model.defer="productos.{{ $index }}.producto"></textarea></td>
                        </tr>
                    @endforeach

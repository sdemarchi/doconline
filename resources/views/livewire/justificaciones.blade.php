            ...
            <div class="table-responsive">
                <table class="table table-vcenter card-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" placeholder="Agregar beneficio" rows="1" wire:model.defer="justifAgregar"></textarea>
                            @error('justifAgregar')
                    ...
                    @foreach($justificaciones as $index => $justificacion)
                        <tr>
                            <td class="ps-2 p-0">
                                <button class="btn btn-ghost-light btn-icon" wire:click="$emit('triggerDelete',{{ $justificacion->idjustifica }})">
                            ...
                            <td>{{ $justificacion->idjustifica }}</td>
                            <td><textarea class="form-control" rows="1" wire:model.defer="justificaciones.{{ $index }}.justificacion"></textarea></td>
                        </tr>
                    @endforeach

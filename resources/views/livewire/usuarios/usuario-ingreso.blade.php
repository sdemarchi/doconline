<div>
    ...
    <div class="ingreso-background">
        ...
        <div class="ingreso-content card">
            <div class="ingreso-header">Registrar ingreso</div>
            <div class="ingreso-columns">
                <div class="col py-2">
                    ...
                    <div class="row">
                        ...
                        <select type="time" class="form-control form-select" wire:model.defer="feriado">
            ...
            <div class="ingreso-buttons-container">
                ...
                <button type="button" class="btn ingreso-switch">Cancelar</button>
            </div>
        </div>
    </div>
    <script>

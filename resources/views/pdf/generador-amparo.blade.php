...
<div id="contenedor-documento">
   <h4 id="titulo">INTERPONE AMPARO POR MORA</h3>
    ...
    <div class="inciso">
        ...
        <h4>IV. RESOLUCIÓN DE EXPEDIENTES ADMINISTRATIVOS ANÁLOGOS</h4>
        <p>
    ...
    <h4>VII. PRUEBA</h4>
    <div class="inciso">
        <h4 style="margin-top:5px">A) I. DOCUMENTAL:</h4>
        <div>
            <ol>
        ...
        <h4>B) INFORMATIVA (en subsidio):</h4>
        <div>
            <p>
    ...
    <h4>VIII. SOLICITUD DE PLAZO UNIFORME PARA DEOX</h4>
    <div class="inciso">
        <p>
            Solicito a V.S. que <b>el plazo prudencial para el DEOX no exceda los cinco días hábiles, independientemente de la jurisdicción territorial</b>, atento que la digitalización integral del sistema judicial federal ha eliminado toda justificación objetiva para diferenciaciones territoriales y ampliar plazos en razón de la distancia viola el principio constitucional de igualdad entre todos los habitantes de la Nación (art. 16 CN). La totalidad de las actuaciones se tramitan mediante plataformas electrónicas donde la notificación es instantánea e idéntica en todo el territorio nacional, siendo anacrónico mantener criterios basados en distancias físicas inexistentes en el mundo digital.
        </p>
        <p>
            La naturaleza sumaria del amparo y el plazo de apelación de apenas 48 horas evidencian que cualquier DEOX superior a cinco días resulta desproporcionado e incompatible con la urgencia constitucional de este instituto destinado a proteger derechos fundamentales. El plazo prudencial del artículo 8° de la Ley 16.986 debe interpretarse conforme esta realidad tecnológica contemporánea que garantiza acceso igualitario y efectivo a la tutela judicial sin discriminaciones territoriales carentes de sustento fáctico.
        </p>
        <p>
            En consecuencia, corresponde que V.S. unifique el plazo en cinco días hábiles, eliminando diferenciaciones que violan la igualdad ante la ley y contradicen los principios de celeridad propios del amparo por mora administrativa.
        </p>
    </div>

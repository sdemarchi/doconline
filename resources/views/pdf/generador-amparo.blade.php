...
<div id="contenedor-documento">
   <h4 id="titulo" class="bold"><u>INTERPONE AMPARO POR MORA</u></h4>
    <p id="vocativo"><b>SR JUEZ FEDERAL:</b></p>
    <div class="inciso">
        <p class="texto-inciso">
    ...
    @if ($paciente->firma_v2)
        <div style="margin-top:70px; text-align:center;">
            <img height="120px" src="{{ $paciente->firma_v2 }}" />
        </div>

    @elseif ($paciente->firma)
       <div style="margin-top:70px; text-align:right;">
            <img height="130px" src="{{ $paciente->firma }}" />
        </div>
    @endif

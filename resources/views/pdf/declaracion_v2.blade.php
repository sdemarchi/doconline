<head>
    ...
    <body>
        ...
        @else
            <div style="position: absolute; left: 520px; bottom: 100px">
                <img style="max-width:110px; max-height:110px" src="{{ $paciente->firma_v2 }}" />
            </div>
            <div style="position: absolute; left: 660px; bottom: 100px">

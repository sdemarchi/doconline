<head>
    ...
    <body>
        ...
        @else
            <div style="position: absolute; left: 50px; bottom: 200px;">
                <img style="max-width:130px; max-height:130px" src="{{ $paciente->firma_v2 }}" />
            </div>
            <div style="position: absolute; left: 210px; bottom: 200px;">
    ...
    <body class="page2">
        ...
        @else
            <div style="position: absolute; left: 50px; bottom: 190px">
                <img style="max-width:130px; max-height:130px" src="{{ $paciente->firma_v2 }}" width="140" />
            </div>
            <div style="position: absolute; left: 210px; bottom: 190px">

...
.pagina:not(:last-child) {
    page-break-after: always;
        ...
        .bloque1 { top: 174px; left: 150px; }
        .bloque2 { top: 353px; left: 150px; }
        .bloque3 { top: 532px; left: 150px; }
        .bloque4 { top: 691px; left: 459px; line-height: 20px; }
        .bloque5 { top: 776px; left: 459px; line-height: 24px; }
        .bloque6 { top: 898px; left: 50px; line-height: 16px; }
        .bloque7 { top: 1050px; left: 80px; }
    </style>
</head>
<body>
    <!-- Página 1 -->
    <div class="pagina pagina1">
        ...
        <div class="bloque bloque4">
            ...
            @if($paciente->salud_mental)<span style="position: fixed; top:557px; left: 180px">{{ $paciente->salud_ment_esp }}</span>@endif<br/>
        </div>
